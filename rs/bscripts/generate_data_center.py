...
def get_phi_contraints():
    delta = np.radians(29.9)
    phi_inits = np.radians([-180.0, 0.0])
...
def generate_scene(args):
    ...
    # print(f"Rack frames: {rack_frame_names}")
    # print(f"Top panels: {top_panel_names}")
    ...
    butils.save_mitsuba_xml(
        folder_dir,
        "scenee",
        ["Wall", "Floor", *reflectors_names, *side_wall_names, *rack_frame_names],
    )
