...
python ./main_ga.py --command "train" --env_id "conference_4ue_allocation" --checkpoint_dir $SOURCE_DIR/test_local_assets/ga_4ue --sionna_config_file $SOURCE_DIR/configs/sionna_conference_4ue.yaml --source_dir $SOURCE_DIR --num_envs 3 --group "PPO_Allocation_Conference_4UE" --name "AdvNorm_Attention_Allocation_Conference_4UE_ga" --wandb "offline" --no_allocator True --seed 50
