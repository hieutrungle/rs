...
python ./main_attention.py --command "train" --env_id "outdoor_2ue_eval" --checkpoint_dir $SOURCE_DIR/local_assets/outdoor/e4tot100/alct_2ue_eval --sionna_config_file $SOURCE_DIR/configs/sionna_outdoor_2ue.yaml --source_dir $SOURCE_DIR --num_envs 4 --group "PPO_Allocation_Outdoor_2UE" --name "outdoor_alct_2ue_eval" --image_dir $SOURCE_DIR/local_assets/outdoor/e4tot100/alct_2ue_eval/images --load_model "/home/hieule/research/rs/local_assets_2/models/checkpoint_1.pt" --load_allocator $SOURCE_DIR/test_local_assets/attention_allocator_models_1/allocator.pt --ep_len 4 --total_episodes 100
