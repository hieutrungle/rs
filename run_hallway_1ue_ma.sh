...
python ./main_1ue_ma.py --command "train" --env_id "hallway_1ue_ma" --checkpoint_dir $SOURCE_DIR/test_local_assets/hallway_1ue_ma --sionna_config_file $SOURCE_DIR/configs/sionna_hallway_1ue_ma.yaml --source_dir $SOURCE_DIR --num_envs 4 --group "PPO_Hallway_L" --name "AdvNorm_Hallway_1ue_ma"
