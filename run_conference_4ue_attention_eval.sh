...
python ./main_attention.py --command "eval" --env_id "conference4ueallocation" --checkpoint_dir $SOURCE_DIR/local_assets/attention_allocator_4ue_c90_maac_critic_regular_attn_256_h4_eval --sionna_config_file $SOURCE_DIR/configs/sionna_conference_4ue.yaml --source_dir $SOURCE_DIR --num_envs 3 --group "PPO_Allocation_Conference_4UE" --name "AdvNorm_Attention_Allocation_Conference_4UE" --seed 100 --ep_len 20 
# --load_model "/home/hieule/research/rs/local_assets/attention_allocator_4ue_c90_maac_critic_regular_attn_256_h4/checkpoint_65.pt" --load_allocator "/home/hieule/research/rs/local_assets/attention_allocator_4ue_c90_maac_critic_regular_attn_256_h4/allocator.pt" --image_dir "/home/hieule/research/rs/local_assets/images_attention_allocator_4ue_c90_maac_critic_regular_attn_256_h4" --attention_dim 256
