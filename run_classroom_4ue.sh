...
python ./main.py --command "train" --env_id "classroom4ue" --checkpoint_dir $SOURCE_DIR/local_assets/models --sionna_config_file $SOURCE_DIR/configs/sionna_classroom_4ue.yaml --replay_buffer_dir $SOURCE_DIR/local_assets/replay_buffer --source_dir $SOURCE_DIR --num_envs 5 --group "PPO_Beamfocusing_Classroom_4UE" --name "PPO_Rew_AdvNorm0"
