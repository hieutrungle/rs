...
python ./main_attention.py --command "train" --env_id "outdoor_2ue" --checkpoint_dir $SOURCE_DIR/local_assets/outdoor_2ue --sionna_config_file $SOURCE_DIR/configs/sionna_outdoor_2ue.yaml --source_dir $SOURCE_DIR --num_envs 5 --group "PPO_Allocation_Outdoor_2UE" --name "outdoor_2ue" --track_wandb False --no_compatibility_scores True