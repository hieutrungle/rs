...
python ./main_attention.py --command "train" --env_id "conference2ueallocation" --checkpoint_dir $SOURCE_DIR/test_local_assets/attention_allocator_models --sionna_config_file $SOURCE_DIR/configs/sionna_conference_2ue.yaml --source_dir $SOURCE_DIR --num_envs 4 --group "PPO_Allocation_Conference_2UE" --name "AdvNorm_Attention_Allocation_Conference_2UE" --ssed 1 --ep_len 30
