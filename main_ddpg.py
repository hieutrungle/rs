...
def main(config: TrainConfig):
    ...
    try:
        ...
        if checkpoint:
            ...
            optimizers["loss_actor"].load_state_dict(checkpoint["optimizer_actor"])
            optimizers["loss_value"].load_state_dict(checkpoint["optimizer_value"])
            ...
            torch.save(
                {
                    ...
                    "optimizer_actor": optimizers["loss_actor"].state_dict(),
                    "optimizer_value": optimizers["loss_value"].state_dict(),
